...
import { API_CATEGORIES, API_FILM } from '../../../../components/constantsAPI'
...
const useAddFilm = async (data) => {  // Khai bao 1 ham bat dong bo, tu dong bien doi 1 ham thanh promise, Khi gọi tới hàm async nó sẽ xử lý mọi thứ và được trả về kết quả trong hàm của nó, Async cho phép sử dụng Await.
