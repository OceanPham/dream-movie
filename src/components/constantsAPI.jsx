...
export const API_FILM = 'http://localhost:8080/api/phims';
export const API_CATEGORIES = 'http://localhost:8080/api/categories';
export const API_SUPPLIER = 'http://localhost:8080/api/suppliers';